...
def example_convert_to_torch(example, dtype=torch.float32):
    ...
    mvf_names = ['bev_coordinate','bev_local_coordinate', 'fv_local_coordinate', 'intensity','bev_mapping_vf', 'fv_mapping_vf', 'bev_mapping_pv', 'fv_mapping_pv','bev_points']
    hv_names = ['bev_mapping_pvs', 'bev_mapping_vfs','voxel_local_coordinates']
